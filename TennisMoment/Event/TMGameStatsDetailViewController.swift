...
class TMGameStatsDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        commonStatsLabel.text = "Stats"
        serveStatsLabel.text = "Serve Stats"
        returnStatsLabel.text = "Return Stats"
    ...
    func setupEvent(game: Game) {
        timeLabel.text = "Date: \(game.startDate.convertToString(formatterString: "yyyy MM-dd HH:mm"))"
        placeLabel.text = "Place: \(game.place)"
        ...
        for setResult in result.indices {
            let config = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "Set \(setResult + 1)", iconName: "checkmark.circle", isServingOnLeft: result[setResult][0] > result[setResult][1] ? true : false, areBothServing: false, isComparing: true, font: UIFont.systemFont(ofSize: 20), leftNum: "\(result[setResult][0])", rightNum: "\(result[setResult][1])")
        ...
        let firstServeInConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "First Serve In", iconName: "checkmark.circle", isServingOnLeft: firstServeIn > firstServeIn2 ? true : false, areBothServing: false, isComparing: firstServeIn != firstServeIn2 ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(lrint(firstServeIn * 100))%", rightNum: "\(lrint(firstServeIn2 * 100))%")
        let firstServeWonConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "First Serve Won", iconName: "checkmark.circle", isServingOnLeft: firstServeWon > firstServeWon2 ? true : false, areBothServing: false, isComparing: firstServeWon != firstServeWon2 ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(lrint(firstServeWon * 100))%", rightNum: "\(lrint(firstServeWon2 * 100))%")
        let secondServeInConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "Second Serve In", iconName: "checkmark.circle", isServingOnLeft: secondServeIn > secondServeIn2 ? true : false, areBothServing: false, isComparing: secondServeIn != secondServeIn2 ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(lrint(secondServeIn * 100))%", rightNum: "\(lrint(secondServeIn2 * 100))%")
        let secondServeWonConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "Second Serve Won", iconName: "checkmark.circle", isServingOnLeft: secondServeWon > secondServeWon2 ? true : false, areBothServing: false, isComparing: secondServeWon != secondServeWon2 ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(lrint(secondServeWon * 100))%", rightNum: "\(lrint(secondServeWon2 * 100))%")
        let breakPointSavedConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "Break Point Saved", iconName: "checkmark.circle", isServingOnLeft: breakPointSaved > breakPointSaved2 ? true : false, areBothServing: false, isComparing: breakPointSaved != breakPointSaved2 ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(lrint(breakPointSaved * 100))%", rightNum: "\(lrint(breakPointSaved2 * 100))%")
        let servePointWonConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "Serve Point Won", iconName: "checkmark.circle", isServingOnLeft: servePointWon > servePointWon2 ? true : false, areBothServing: false, isComparing: servePointWon != servePointWon2 ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(lrint(servePointWon * 100))%", rightNum: "\(lrint(servePointWon2 * 100))%")
        let serveGameWonConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "Serve Game Won", iconName: "checkmark.circle", isServingOnLeft: serveGameWon > serveGameWon2 ? true : false, areBothServing: false, isComparing: serveGameWon != serveGameWon2 ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(lrint(serveGameWon * 100))%", rightNum: "\(lrint(serveGameWon2 * 100))%")

        let firstReturnServeInConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "First Return In", iconName: "checkmark.circle", isServingOnLeft: firstReturnServeIn > firstReturnServeIn2 ? true : false, areBothServing: false, isComparing: firstReturnServeIn != firstReturnServeIn2 ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(lrint(firstReturnServeIn * 100))%", rightNum: "\(lrint(firstReturnServeIn2 * 100))%")
        let firstReturnServeWonConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "First Return Won", iconName: "checkmark.circle", isServingOnLeft: firstReturnServeWon > firstReturnServeWon2 ? true : false, areBothServing: false, isComparing: firstReturnServeWon != firstReturnServeWon2 ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(lrint(firstReturnServeWon * 100))%", rightNum: "\(lrint(firstReturnServeWon2 * 100))%")
        let secondReturnServeInConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "Second Return In", iconName: "checkmark.circle", isServingOnLeft: secondReturnServeIn > secondReturnServeIn2 ? true : false, areBothServing: false, isComparing: secondReturnServeIn != secondReturnServeIn2 ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(lrint(secondReturnServeIn * 100))%", rightNum: "\(lrint(secondReturnServeIn2 * 100))%")
        let secondReturnServeWonConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "Second Return Won", iconName: "checkmark.circle", isServingOnLeft: secondReturnServeWon > secondReturnServeWon2 ? true : false, areBothServing: false, isComparing: secondReturnServeWon != secondReturnServeWon2 ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(lrint(secondReturnServeWon * 100))%", rightNum: "\(lrint(secondReturnServeWon2 * 100))%")
        let breakPointConvertConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "Break Point Convert", iconName: "checkmark.circle", isServingOnLeft: breakPointConvert > breakPointConvert2 ? true : false, areBothServing: false, isComparing: breakPointConvert != breakPointConvert2 ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(lrint(breakPointConvert * 100))%", rightNum: "\(lrint(breakPointConvert2 * 100))%")
        let returnPointWonConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "Return Point Won", iconName: "checkmark.circle", isServingOnLeft: returnPointWon > returnPointWon2 ? true : false, areBothServing: false, isComparing: returnPointWon != returnPointWon2 ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(lrint(returnPointWon * 100))%", rightNum: "\(lrint(returnPointWon2 * 100))%")
        let returnGameWonConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "Return Game Won", iconName: "checkmark.circle", isServingOnLeft: returnGameWon > returnGameWon2 ? true : false, areBothServing: false, isComparing: returnGameWon != returnGameWon2 ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(lrint(returnGameWon * 100))%", rightNum: "\(lrint(returnGameWon2 * 100))%")

        let acesConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "Aces", iconName: "checkmark.circle", isServingOnLeft: game.player1Stats.aces > game.player2Stats.aces ? true : false, areBothServing: false, isComparing: game.player1Stats.aces != game.player2Stats.aces ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(game.player1Stats.aces)", rightNum: "\(game.player2Stats.aces)")
        let doubleFaultsConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "Double Faults", iconName: "checkmark.circle", isServingOnLeft: game.player1Stats.doubleFaults > game.player2Stats.doubleFaults ? true : false, areBothServing: false, isComparing: game.player1Stats.doubleFaults != game.player2Stats.doubleFaults ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(game.player1Stats.doubleFaults)", rightNum: "\(game.player2Stats.doubleFaults)")
        let returnAcesConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "Return Aces", iconName: "checkmark.circle", isServingOnLeft: game.player1Stats.returnAces > game.player2Stats.returnAces ? true : false, areBothServing: false, isComparing: game.player1Stats.returnAces != game.player2Stats.returnAces ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(game.player1Stats.returnAces)", rightNum: "\(game.player2Stats.returnAces)")
        let netPointsConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "Net Points", iconName: "checkmark.circle", isServingOnLeft: game.player1Stats.netPoints > game.player2Stats.netPoints ? true : false, areBothServing: false, isComparing: game.player1Stats.netPoints != game.player2Stats.netPoints ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(game.player1Stats.netPoints)", rightNum: "\(game.player2Stats.netPoints)")
        let unforcedErrorsConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "UE", iconName: "checkmark.circle", isServingOnLeft: game.player1Stats.unforcedErrors > game.player2Stats.unforcedErrors ? true : false, areBothServing: false, isComparing: game.player1Stats.unforcedErrors != game.player2Stats.unforcedErrors ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(game.player1Stats.unforcedErrors)", rightNum: "\(game.player2Stats.unforcedErrors)")
        let forehandWinnersConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "FH Winners", iconName: "checkmark.circle", isServingOnLeft: game.player1Stats.forehandWinners > game.player2Stats.forehandWinners ? true : false, areBothServing: false, isComparing: game.player1Stats.forehandWinners != game.player2Stats.forehandWinners ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(game.player1Stats.forehandWinners)", rightNum: "\(game.player2Stats.forehandWinners)")
        let backhandWinnersConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: false, isTitleHidden: false, title: "BH Winners", iconName: "checkmark.circle", isServingOnLeft: game.player1Stats.backhandWinners > game.player2Stats.backhandWinners ? true : false, areBothServing: false, isComparing: game.player1Stats.backhandWinners != game.player2Stats.backhandWinners ? true : false, font: UIFont.systemFont(ofSize: 17), leftNum: "\(game.player1Stats.backhandWinners)", rightNum: "\(game.player2Stats.backhandWinners)")
