...
struct Stats {
    ...
    init(id: Int, aces: Int, doubleFaults: Int, servePoints: Int, firstServePoints: Int, firstServePointsIn: Int, firstServePointsWon: Int, secondServePointsWon: Int, breakPointsFaced: Int, breakPointsSaved: Int, serveGamesPlayed: Int, serveGamesWon: Int, returnAces: Int, returnServePoints: Int, firstServeReturnPoints: Int, firstServeReturnPointsWon: Int, secondServeReturnPointsWon: Int, breakPointsOpportunities: Int, breakPointsConverted: Int, returnGamesPlayed: Int, returnGamesWon: Int, netPoints: Int, unforcedErrors: Int, forehandWinners: Int, backhandWinners: Int) {
        self.id = id
        self.aces = aces
