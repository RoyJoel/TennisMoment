...
let club: Club = Club(id: 1, icon: "JasonZhang", name: "TennisMoment", intro: "Tennis Moment is world NO.2 Tennis Association", ownerId: 2, address: "Germany")
let clubs = [club, club, club, club, club, club]
let players: [Player] = [Player(loginName: "jasony", name: "Nick Kyrgios", icon: "Nick Kyrgios", sex: .Man, age: 21, yearsPlayed: 1, height: 10_000_000, width: 1, grip: .Western, backhand: .TwoHandedBackhand, points: 1000, isAdult: true, careerStatsId: 1, friends: "p"),
                         Player(loginName: "zhangjiacheng", name: "Jason Zhang", icon: "Jason Zhang", sex: .Man, age: 21, yearsPlayed: 1, height: 1, width: 1, grip: .Western, backhand: .TwoHandedBackhand, points: 1000, isAdult: true, careerStatsId: 1, friends: "p"),
                         Player(loginName: "", name: "", icon: "person", sex: .Man, age: 1, yearsPlayed: 1, height: 1, width: 1, grip: .Continented, backhand: .TwoHandedBackhand, points: 1, isAdult: false, careerStatsId: 1, friends: "zhangjiacheng")]
//
