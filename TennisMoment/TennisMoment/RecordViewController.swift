...
//        let setView = TMVSViewConfig(isTitleViewAbovePointView: true, isTitleHidden: true, title: "SET", iconName: "TennisBall", isShowingOnLeft: true, font: UIFont.systemFont(ofSize: 17), leftNum: 0, rightNum: 0)
//        let gameView = TMVSViewConfig(isTitleViewAbovePointView: true, isTitleHidden: true, title: "GAME", iconName: "TennisBall", isShowingOnLeft: true, font: UIFont.systemFont(ofSize: 17), leftNum: 0, rightNum: 0)
//        let pointView = TMVSViewConfig(isTitleViewAbovePointView: true, isTitleHidden: true, title: "POINT", iconName: "TennisBall", isShowingOnLeft: true, font: UIFont.systemFont(ofSize: 17), leftNum: 0, rightNum: 0)
//        let pointRecordViewConfig = TMPointRecordViewConfig(rowHeight: 50, rowSpacing: 10, numberOfRow: 3, Configs: [setView, gameView, pointView])
