...
//        pointRecordView.frame = CGRect(x: 24 + leftBasicInfoView.frame.width, y: 27 + ((UIStandard.shared.screenHeight * 0.24 - 163) / 2), width: UIStandard.shared.screenWidth *  0.12, height: 180)
//       
//    }
//
