    ...
    override func viewDidLoad() {
        ...
        recordView.tab_startAnimation {
            DispatchQueue.main.async {
                TMGameRequest.SearchRecentGames(playerId: TMUser.user.id, num: 1) { games in
                    if games.count == 1 {
