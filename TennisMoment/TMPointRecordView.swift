...
class TMPointRecordView: TMView {
    ...
    func scaleTo(newRowHeight: CGFloat, newRowSpacing: CGFloat, newFont: UIFont, isTitleHidden: Bool) {
        let setConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: true, isTitleHidden: isTitleHidden, title: "SET", iconName: "TennisBall", isServingOnLeft: true, areBothServing: false, isComparing: false, font: newFont, leftNum: config.setLeftNum, rightNum: config.setRightNum)
        let gameConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: true, isTitleHidden: isTitleHidden, title: "GAME", iconName: "TennisBall", isServingOnLeft: true, areBothServing: false, isComparing: false, font: newFont, leftNum: config.gameLeftNum, rightNum: config.gameRightNum)
        let pointConfig = TMPointComparingViewConfig(isTitleViewAbovePointView: true, isTitleHidden: isTitleHidden, title: "POINT", iconName: "TennisBall", isServingOnLeft: true, areBothServing: false, isComparing: true, font: newFont, leftNum: config.pointLeftNum, rightNum: config.pointRightNum)
